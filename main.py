...
from model.SDSTGCN import SDSTGCN as Network
...
# load dataset
train_loader, val_loader, test_loader, scaler = get_dataloader(args, normalizer=args.normalizer, tod=args.tod, dow=True, weather=False, single=False)
