    ...
    def train_epoch(self, epoch, i=2):
        ...
        for batch_idx, (data, target) in enumerate(self.train_loader):
            ...
            if (batch_idx+1) % self.args.log_step == 0:
                self.logger.info('Train Epoch {}: {}/{} Loss: {:.6f}'.format(epoch, batch_idx+1, self.train_per_epoch, loss.item()))
        train_epoch_loss = total_loss/self.train_per_epoch
        self.logger.info('**********Hidden unit:{}, Train Epoch {}: averaged Loss: {:.6f}'.format(self.args.rnn_units, epoch, train_epoch_loss))
